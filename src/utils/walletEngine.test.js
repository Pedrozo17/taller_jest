...
describe('Wallet Engine Tests', () => {
  ...
  test('Transacciones menores a $50.000 COP deben sumar exactamente 0 puntos ADSO', () => {
    const mockTransactions = [
      {
        type: 'Retiro',
        amount: 49999.99,
    ...
    const result = calculateAdsoPoints(mockTransactions);
    expect(result).toBe(0);
  });

  test('Transacciones Rechazadas o Pendientes no acumulan puntos ADSO bajo ninguna circunstancia', () => {
    const mockTransactions = [
      {
        type: 'Retiro',
        amount: 200000,
